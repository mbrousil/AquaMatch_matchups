...
LS4_fp <- file.path(rs_download_path, "siteSR_Landsat4_DSWE1_2025-06-06.feather")
LS5_fp <- file.path(rs_download_path, "siteSR_Landsat5_DSWE1_2025-06-06.feather")
LS7_fp <- file.path(rs_download_path, "siteSR_Landsat7_DSWE1_2025-06-06.feather")
LS8_fp <- file.path(rs_download_path, "siteSR_Landsat8_DSWE1_2025-06-06.feather")
LS9_fp <- file.path(rs_download_path, "siteSR_Landsat9_DSWE1_2025-06-06.feather")

# grab site ids with datestamp, arrange and grab the top one (most recent according 
# to the date)
site_drive_ids <- read_csv("in/siteSR_data/site_locations_drive_ids.csv") %>% 
...
# load sites
site_locs <- read_rds(file.path(rs_download_path, (site_drive_ids$name)))
